...
import { Header, ItemTitle, Img, Field } from '@/pages/Signup/helpers';
...
const index = () => {
  return (
    ...
    >
      ...
      <Link to="/">
        <ArrowBackIcon style={{alignItems: "flex-start"}}/>
      </Link>
        <Img src={img} />
      </Header>
      <Field>
      ...
      <ItemTitle>Register for free</ItemTitle>
        {userOnboarding.map((el) => (
          <Element style={{ maxHeight: '100px', maxWidth: '600px' }}>
            <CardText style={{ alignItems: 'flex-start', padding: '30px' }}>
