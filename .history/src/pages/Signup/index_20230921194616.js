...
import { InnerContainer, Header, ItemTitle, Form, Img, Field, FieldLabel, StyledInput, ButtonInput, Error, Wrapper } from '@/pages/Signup/helpers';
...
export default function Signup() {
  ...
  const schema = yup
    .object({
      ...
      password: yup.string().required('Password is a required field').min(8, 'Minimum length of password must be 8 characters'),
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Field>
            ...
            <Wrapper>
              ...
              <StyledInput type="tel" placeholder="Your Mobile number" {...register('mobileNumber')} style={{ flex: 9 }} />
            </Wrapper>
          ...
          <Field>
            <Wrapper>
              ...
              <Text style={{ fontSize: fontSizes.xSmall, flex: '18' }}>
                I agree to the <StyledLink to={legal[0][0]}>Terms and Conditions</StyledLink> and <StyledLink to={legal[1][0]}>Privacy Policy.</StyledLink>
              </Text>
            </Wrapper>
