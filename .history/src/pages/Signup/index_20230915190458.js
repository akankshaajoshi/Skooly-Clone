    ...
    <Container style={{ backgroundColor: `${colors.quaternary}`, borderRadius: `${borderRadius.large}` }}>
      <InnerContainer>
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <ToggleMenu>
                <Button onClick={()=>{setToggle(!toggle)}} style={{width: "100%", borderRadius: `${borderRadius.large}`}}> Parent </Button>
                <Button onClick={()=>{setToggle(!toggle)}} style={{width: "100%",  borderRadius: `${borderRadius.large}`}}> Student </Button>
            </ToggleMenu>
