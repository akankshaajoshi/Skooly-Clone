    ...
    <Container style={{ backgroundColor: `${colors.quaternary}`, borderRadius: `${borderRadius.large}` }}>
      <InnerContainer>
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          ...
          <input type="text" placeholder="Your First name" {...register('First name', { required: true, maxLength: 80 })} />
          <input type="text" placeholder="Your Last name" {...register('Last name', { required: true, maxLength: 100 })} />
          <input type="text" placeholder="Your Email address" {...register('Email', { required: true, pattern: /^\S+@\S+$/i })} />
          <input
            type="tel"
