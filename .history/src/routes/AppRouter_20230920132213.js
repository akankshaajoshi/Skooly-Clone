...
import AddStudentContainer from "@/containers/import AddStudentContainer from "@/containers/EnrollStudentContainer"
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/register-school/preschool/dashboard/schedule" element={loginState ? <Dashboard children={<ScheduleContainer/>}/> : <Navigate to="/" />} />
        <Route path="/register-school/preschool/dashboard/student" element={loginState ? <Dashboard children={<EnrollStudentContainer/>}/> : <Navigate to="/" />} />
        <Route path="/register-school/preschool/dashboard/addstudent" element={loginState ? <Dashboard children={<AddStudentContainer/>}/> : <Navigate to="/" />} />
      </Routes>
    </>
  );
};
