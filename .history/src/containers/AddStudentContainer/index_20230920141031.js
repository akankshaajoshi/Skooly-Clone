      ...
      <SlidingWindowContent>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <FormGroup>
            ...
            <Label htmlFor="fnumber">Father Number:</Label>
            <Input type="text" id="fnumber" name="formData.father.number" value={formData.father.number} onChange={handleInputChange} />
          </FormGroup>
          <div>
