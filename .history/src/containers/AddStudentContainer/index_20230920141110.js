    ...
    <SlidingWindowContainer style={{}} open={open}>
      <SlidingWindowContent>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <FormGroup>
            <Label htmlFor="femail">Father Email:</Label>
            <Input type="text" id="femail" name="formData.father.email" value={formData.father.email} onChange={handleInputChange} />
            <Label htmlFor="formData.father.number">Father Number:</Label>
            <Input type="text" id="formData.father.number" name="formData.father.number" value={formData.father.number} onChange={handleInputChange} />
          </FormGroup>
          <div>
