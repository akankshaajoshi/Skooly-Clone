...
import StyledSelectTime from '@/components/custom/StyledSelectTime/StyledSelectTime';
import StyledSelectCurrency from '@/components/custom/StyledSelectCurrency/StyledSelectCurrency';
    ...
    >
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Field>
          ...
          <Wrapper>
            <StyledSelectTime {...register('timeZone')} style={{ flex: 1 }} />
        ...
        <Field>
          <Wrapper>
            ...
            <Text style={{ fontSize: fontSizes.xSmall, flex: '18' }}>
              I agree to the{' '}
              <StyledLink to={legal[0][0]}>Terms and Conditions</StyledLink> and{' '}
