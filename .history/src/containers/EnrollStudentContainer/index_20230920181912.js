...
function FilterableTable() {
  ...
  const handleDeleteClick = () => {
    const updatedStudents = fakeStudents.filter((student) => !selectedRows.includes(student.name));
    // Call the deleteStudentData function here if necessary
  deleteStudentData(updatedStudents);
