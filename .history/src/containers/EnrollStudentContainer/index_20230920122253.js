...
function FilterableTable() {
  ...
  const filteredCourses = fakeStudents
    ? fakeStudents.filter((student) => {
        return (
          student.courseName.toLowerCase().startsWith(filter.courseName.toString().toLowerCase()) &&
          student.classType.toString().toLowerCase().startsWith(filter.classType.toString().toLowerCase()) &&
          student.category.toString().toLowerCase().startsWith(filter.category.toString().toLowerCase()) &&
          student.pricingOption.toString().toLowerCase().startsWith(filter.pricingOption.toString().toLowerCase()) &&
          student.branches.toString().toLowerCase().startsWith(filter.branches.toString().toLowerCase())
        );
      })
      : [];
