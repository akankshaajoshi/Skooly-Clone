...
import { stats, statLabels } from '@/utils/constants';
...
const Index = () => {
  return (
    <Container style={{ backgroundColor: `${colors.quaternary}`, flexDirection: 'row', paddingLeft: "80px", paddingRight: "80px", height: `${heights.medium}`}}>
