  ...
  for (let i = 0; i < count; i++) {
    const staff = {
      ...
      designation: faker.helpers
        ...
        .toString(),
      location: faker.helpers.uniqueArray(['Main', 'Other']).toString(),
      role: faker.helpers.uniqueArray(["Admin & Teaching", "Teaching"], 1).toString(),
      billing: faker.helpers.uniqueArray(["Full access", "View access", "Disable access"]),
    };
    students.push(student);
  }
  return students;
